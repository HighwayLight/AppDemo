...
import com.example.myapplication.camera.CameraXView.CaptureMode;
...
final class CameraXModule {
    ...
    void bindToLifecycleAfterViewMeasured() {
        ...
        if (getCaptureMode() == CaptureMode.IMAGE) {
            ...
            mCamera = mCameraProvider.bindToLifecycle(mCurrentLifecycle, cameraSelector,
                    mVideoCapture,
                    mPreview);
        } else if (getCaptureMode() == CaptureMode.MIXED){
            mCamera = mCameraProvider.bindToLifecycle(mCurrentLifecycle, cameraSelector,
                    mImageCapture,
    ...
    public ImageAnalysis getImgAnalysis() {
        return analysis;
    }

    public void setImgAnalysis(ImageAnalysis analysis) {
