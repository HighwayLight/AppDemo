...
public class MediaLoader extends LoaderM implements LoaderManager.LoaderCallbacks {
    ...
    public void onLoadFinished(Loader loader, Object o) {
        ...
        Folder allFolder = new Folder(mContext.getResources().getString(R.string.tma_all_dir_name));
        folders.add(allFolder);
        Folder allVideoDir = new Folder(mContext.getResources().getString(R.string.tma_video_dir_name));
